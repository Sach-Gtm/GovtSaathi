    ...
    >
      <defs>
        <linearGradient id="lmGold" x1="0" y1="0" x2="1" y2="1">
          ...
          <stop offset="1" stopColor="#C79A00" />
        </linearGradient>
      ...
      {/* Left pan */}
      <path d="M22 60 Q36 72 46 60 Z" fill="url(#lmGold)" stroke="#8A6B00" strokeWidth="1" />
      {/* Right pan */}
      <path d="M54 60 Q64 72 78 60 Z" fill="url(#lmGold)" stroke="#8A6B00" strokeWidth="1" />
      ...
      <g transform="translate(70 22)">
        <circle cx="0" cy="0" r="10" fill="url(#lmGold)" />
