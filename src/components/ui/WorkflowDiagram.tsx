    ...
    >
      <defs>
        <linearGradient id="wfConn" x1="0" y1="0" x2="1" y2="0">
          ...
          <stop offset="0.5" stopColor="#0B5FFF" stopOpacity="0.6" />
          <stop offset="1" stopColor="#0B5FFF" stopOpacity="0.15" />
        </linearGradient>
      ...
      <circle cx="140" cy="130" r="6" fill="#F5C400" className="gs-flow-dot">
      ...
      {[
        ...
        <g key={s.title} transform={`translate(${s.x} 130)`}>
          <circle cx="0" cy="0" r="46" fill="#FFFFFF" stroke="#E4E1D6" strokeWidth="1.5" />
          <circle cx="0" cy="0" r="46" fill="#0B5FFF" opacity="0.06" />
...
function ShopIcon() {
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
      ...
      <path d="M11 15 A2 2 0 0 0 15 15 A2 2 0 0 0 19 15 A2 2 0 0 0 23 15 A2 2 0 0 0 27 15" stroke="#F5C400" strokeWidth="1.6" />
    </svg>
  );
}
function MapIcon() {
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
      ...
      <circle cx="20" cy="18" r="3" fill="#F5C400" />
    </svg>
  );
}
function ClipboardIcon() {
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
      ...
      <circle cx="26" cy="26" r="4" fill="#F5C400" />
...
function ScanIcon() {
  return (
    <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
      ...
      <rect x="14" y="12" width="3" height="3" fill="#F7F5EF" />
      <rect x="19" y="12" width="3" height="3" fill="#F7F5EF" />
      <rect x="14" y="17" width="3" height="3" fill="#F7F5EF" />
      <rect x="19" y="17" width="3" height="3" fill="#F7F5EF" />
